...
const { subCategories, species } = storeToRefs(productStore)
        ...
        <div class="shop-submenu">
          <ul>
            <li v-for="(item, index) in species" :key="index">
              <a type="button" @click="search('specie_id', item.id)">{{ item.nombre }}
        ...
        <div class="shop-submenu">
          <ul>
            <li v-for="(item, index) in subCategories" :key="index">
              <a type="button" @click="search('subCategory_id', item.id)">
